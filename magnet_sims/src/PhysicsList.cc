 ...
 fMessenger(0),fEmPhysicsList(0)
{
  ...
  // EM physics
  fEmName = G4String("empolarized");
  fEmPhysicsList = new PhysListEmPolarized(fEmName);
...
void PhysicsList::AddPhysicsList(const G4String& name)
{
  ...
  if (name == "local") {
    ...
    AlterPhysicsList(name, new PhysListEmPolarized());
    ...
    AlterPhysicsList(name, new G4EmLivermorePolarizedPhysics());
